...
const offerUrl = ref("https://jogosblanko.sbs");
const logoSrc = ref(new URL("../assets/pl-package/loto-logo.png", import.meta.url).href);

const onGameCompleted = (data: unknown) => {
  console.log("Game completed:", data);
};

const onRewardsClaimed = (data: unknown) => {
