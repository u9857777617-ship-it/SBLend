<template>
  <div class="it-cases-landing" :style="rootStyle">
      ...
      <div class="background">
          ...
          <div class="logo">
            ...
            <div class="chest-subtitle">
              <span>APRI E TROVA</span>
              <img :src="bonusImage" alt="777" class="small-777-icon">
              <br>
              <span>E ATTIVA IL TUO BONUS</span>
            </div>
          <div class="chests-panel">
          <div class="chests-grid" role="group" aria-label="Scegli un forziere">
            <div v-for="(chest, index) in chests" :key="index" class="chest-wrap">
              ...
              <div
                ...
                tabindex="0"
              >
                <img :src="openButtonImage" alt="OTTENERE" class="ottenere-btn-img">
              </div>
            </div>
          </div>
          </div>
...
const props = defineProps({
  ...
  texts: {
    ...
    default: () => ({
      loader: 'CARICAMENTO...',
      subtitle: 'APRI E TROVA<br>E ATTIVA IL TUO BONUS',
      bonusText: 'VINCITA<br>300 GIRI E 150 EURO<br>SUL PRIMO DEPOSITO',
      bonusButton: 'RITARE',
      bonusLoading: 'CARICAMENTO...'
    })
  },
  offerUrl: {
    type: String,
...
.chest-label.disabled .ottenere-btn-img {
  opacity: 0.6;
  filter: grayscale(20%);
  cursor: default;
}

.ottenere-btn-img:hover {
  transform: scale(1.1);
