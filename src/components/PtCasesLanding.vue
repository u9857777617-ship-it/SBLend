<template>
  <div class="pt-cases-landing" :style="rootStyle">
    <div v-if="showLoader" id="loader" class="loader" :style="loaderStyle">
      <div class="loader-logo">
        <img :src="logoImage" alt="Logo" decoding="async" fetchpriority="high">
      </div>
      ...
      <div class="background">
          ...
          <div class="logo">
            ...
            <div class="chest-subtitle">
              <span>ABRE E ENCONTRA</span>
              <img :src="bonusImage" alt="777" class="small-777-icon">
              <br>
              <span>E ATIVA O TEU BÓNUS</span>
            </div>
          <div class="chests-panel">
          <div class="chests-grid" role="group" aria-label="Escolha um baú">
            <div v-for="(chest, index) in chests" :key="index" class="chest-wrap">
              ...
              >
                <img 
                  ...
                  :alt="`Baú ${chest.isOpened ? 'aberto' : 'fechado'} ${index + 1}`" 
                  decoding="async" 
              ...
              <div
                ...
                tabindex="0"
              >
                <img :src="openButtonImage" alt="ABRIR" class="abrir-btn-img">
              </div>
            </div>
          </div>
          </div>
    ...
    <div v-if="!showLoader && currentScreen === 4" id="screen4" class="screen active">
      <div class="background">
        <div class="bonus-container">
          <div class="logo">
            <img :src="logoImage" alt="Logo" loading="lazy" decoding="async">
          </div>
...
const props = defineProps({
  ...
  texts: {
    ...
    default: () => ({
      loader: 'CARREGANDO...',
      subtitle: 'ABRE E ENCONTRA<br>E ATIVA O TEU BÓNUS',
      bonusText: 'VITÓRIA<br>300 RODADAS E 150 EUROS<br>NO PRIMEIRO DEPÓSITO',
      bonusButton: 'RITIRARE',
      bonusLoading: 'CARREGANDO...'
    })
  },
  offerUrl: {
    type: String,
  ...
  logoSrc: {
    type: String,
    default: () => new URL('../assets/pt-cases/pt-logo.png', import.meta.url).href
  }
})
...
const openButtonImage = computed(() => new URL('../assets/pt-cases/pt-btn-abrir.png', import.meta.url).href)
const sponsorBannerImage = computed(() => new URL('../assets/fr-cases/sponsors-banner.png', import.meta.url).href)
const backgroundImage = computed(() => new URL('../assets/pt-cases/pt-background.png', import.meta.url).href)
...
.chests-panel {
  ...
  background: linear-gradient(180deg, #00FF66 0%, #00BF56 100%);
...
.chest-label.disabled .abrir-btn-img {
  opacity: 0.6;
  filter: grayscale(20%);
  cursor: default;
}
